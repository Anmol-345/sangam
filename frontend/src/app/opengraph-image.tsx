...
export const alt = 'sangam. — Rotating Savings on Botchain';
  ...
  return new ImageResponse(
    (
      <div style={{ background: '#fafafa', width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '80px', fontFamily: 'sans-serif' }}>
        ...
        <div style={{ fontSize: 36, color: '#71717a', marginTop: 32, letterSpacing: '-0.02em' }}>Rotating savings on Botchain.</div>
