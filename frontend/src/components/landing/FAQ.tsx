...
const faqs = [
  ...
  {
    q: "Is it safe?",
    a: "Your money is held in a Solidity smart contract on the Botchain blockchain. No single person — not even us — can move it. Only the contract rules decide when and to whom funds are released.",
  },
  {
